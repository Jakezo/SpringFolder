...
public class BoardController {
	...
	public String goView02(HttpServletRequest request, Model model) {
		...
		// model을 이용해서 request에 속성(attribute)으로 다시 저장하겠습니다.
	...
	public String goView03(@RequestParam("name") String name,
		...
		// @RequestParam("age") int age: 파라미터 age를 int age 에 저장하세요.
	...
	*/
	...
	@RequestMapping("v06")
	public String goView06(@RequestParam(value="title", required=false, defaultValue="공지") String title,
	...
	@RequestMapping("v11")
	public String goView231(@ModelAttribute("title") String title,
