...
public class Controller {
	...
	/*
	  ModelAndView 클래스
	 1. 스프링 이전에 사용하던 클래스로 (아마도) 현재 많이 생산되어 있는 코드이다.
	 ...
	 4. Model은 request라고 생각하시면 편합니다.
	 	-Controller가 JSP에게 전달하고자 하는 데이터를 속성(attribute)으로 저장하는 클래스이다.
	...
	public ModelAndView goView01() {
		...
		mav.setViewName("view01");  // /WEB-INF/views/view01.jsp 로 이동됩니다.
		return mav;
	}
	
	// 지금까지 JSP로 이동하는 방식은
	// 100% forward 였습니다. redirect 하는 방법은 나중에 다루게 된다.
	
	// forward 이기 때문에 JSP로 데이터를 보낼 수 있습니다.
